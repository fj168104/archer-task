...
public class XbootGenerator {
     ...
     * 建议仅需修改
     */
    private static final String className = "Archer";
    ...
    public static void main(String[] args) throws Exception {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/archer-web/src/main/java/cn/exrick/xboot/generator/template";
    ...
    private static void generateCode(GroupTemplate gt) throws Exception{
        ...
        //创建文件
        String entityFileUrl = System.getProperty("user.dir")+"/archer-web/src/main/java/"+ dotToLine(entityPackage) + "/" + className + ".java";
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir")+"/archer-web/src/main/java/"+ dotToLine(daoPackage) + "/" +className + "Dao.java";
        ...
        //创建文件
        String serviceFileUrl = System.getProperty("user.dir")+"/archer-web/src/main/java/"+ dotToLine(servicePackage) + "/" + className + "Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = System.getProperty("user.dir")+"/archer-web/src/main/java/"+ dotToLine(serviceImplPackage) + "/" + className + "ServiceImpl.java";
        ...
        //创建文件
        String controllerFileUrl = System.getProperty("user.dir")+"/archer-web/src/main/java/"+ dotToLine(controllerPackage) + "/" + className + "Controller.java";
    ...
    private static void deleteCode(String className) throws IOException{
        ...
        String entityFileUrl = System.getProperty("user.dir")+"/archer-web/xboot-plus-back/src/main/java/"+ dotToLine(entityPackage) + "/" +className+".java";
        File entityFile = new File(entityFileUrl);
        if(entityFile.exists()){
            entityFile.delete();
        }
