        ...
        <Card>
          <Row @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
              ...
              <span v-if="drop">
                <Form-item label="下一任务执行节点" prop="nextExecuteNode">
                  <Input type="text" v-model="searchForm.nextExecuteNode" placeholder="请输入下一任务执行节点" clearable style="width: 200px"/>
                </Form-item>
                <Form-item label="运行结果/下一任务所需参数" prop="runResult">
                  <Input type="text" v-model="searchForm.runResult" placeholder="请输入运行结果/下一任务所需参数" clearable style="width: 200px"/>
                </Form-item>
    ...
    <Modal :title="modalTitle" v-model="modalVisible" :mask-closable='false' :width="500">
      <Form ref="form" :model="form" :label-width="100" :rules="formValidate" >        <FormItem label="任务实例Id" prop="taskId" >
        ...
        <FormItem label="运行结果/下一任务所需参数" prop="runResult" >
          <Input v-model="form.runResult" style="width:100%"/>
        </FormItem>
        ...
        <FormItem label="执行异常" prop="exception" >
          <Input v-model="form.exception" style="width:100%"/>
        </FormItem>
